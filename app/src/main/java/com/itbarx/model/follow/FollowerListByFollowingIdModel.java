...
public class FollowerListByFollowingIdModel {
	...
	public FollowerListByFollowingIdModel() {
	super();
	}

	public FollowerListByFollowingIdModel(String rowNum, String followerID_FK, String followingID_FK, String followRelationStatusE, String followingDate, String followingPendingStatus, String userID,
