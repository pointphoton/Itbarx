...
public class F_SearchFragment extends Fragment {
	...
	com.itbarx.custom.component.CustOpenRegularTextView txtToolbar;
	EditText searchPersonEdtTxt;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		textSizeEdtTxt= TEXTVIEW_TEXT_SIZE / (getResources().getDisplayMetrics().density);
		txtToolbar = (com.itbarx.custom.component.CustOpenRegularTextView) t_searchActivity.findViewById(R.id.search_fragment__toolbar_textView);
		searchPersonEdtTxt =(EditText) t_searchActivity.findViewById(R.id.search_fragment_screen_search_edittext);
