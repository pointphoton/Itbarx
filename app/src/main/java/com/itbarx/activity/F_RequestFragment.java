...
public class F_RequestFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		btnOpenActivity = (Button) getActivity().findViewById(R.id.request_fragment_activity_button);
		btnOpenActivity.setOnClickListener(openActivityClickListener);

		//fills up the listview
		requestListView =(ListView)getActivity().findViewById(R.id.fragment_request_screen_listview);
